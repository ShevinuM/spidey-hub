...
A visual recipe is not a second copy of an e2e flow. It reuses the feature's `tests/ui/pages/` page object only to *navigate directly* to the state it needs — never to replay a multi-step user journey:
