...
const FIXTURE_GLOB = import.meta.glob(
  "../../features/repositories/tests/ui/support/commits/*.json",
  {
    eager: true,
    import: "default",
  },
...
export const commitsDir = USE_FIXTURES
  ? "src/features/repositories/tests/ui/support/commits"
  : "src/generated/commits";
