...
export type ViewId = "home" | "builds" | "employment" | "retina-v" | "profile" | "help";
 ...
 * builds/employment/profile/retina-v ids. This is the one place the two
 * vocabularies meet.
 */
 ...
 * window is a real, always-listed entry (0:dashboard 1:builds 2:employment
 ...
 * window id already equals its ViewId verbatim (builds/employment/retina-v/
 * profile/help). */
 ...
 *   content/repositories|Builds.svelte         -> builds
...
export function grepPathToView(path: string): ViewId | null {
  ...
  if (/(^|\/)content\/repositories\/|(^|\/)Builds\.svelte$/.test(path)) return "builds";
