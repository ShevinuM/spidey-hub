...
// `height:30px` and GrepOverlay.svelte's backdrop clip (PLAN.md Phase 5 item
// 5.5: "the grep overlay's dim/blur backdrop must NOT cover the status
// bar") both need the exact same pixel value — a single source avoids the
