...
- [ ] Extract fixtures from `Homepage.dc.html` verbatim: `fixtures/projects/*.md` (4 sample projects incl. commits+repos as frontmatter/JSON), `fixtures/grep-index.json` (22-file `repoSrc`), `fixtures/commits/*.json`.
...
- [ ] Run `mcp__svelte__svelte-autofixer` (via ToolSearch) over every new .svelte component until clean.
- [ ] Commit.
